...
public class SpaceInvaders extends Application {
    ...
    //Boss sprites
    static final Image BOSS_H_IMG = new Image("file:images/player.png");
    static final Image BOSS_IMG = new Image("file:images/player.png");
...
//        }
    ...
    public class BossH extends Rocket {
        ...
        public BossH(int posX, int posY, int size, Image image) {
            super(posX, posY, size, image);
            hitpoints = 30 + (10*MAX_HITPOINTS)/2;
    ...
    public class Boss extends Rocket {
        ...
        public Boss(int posX, int posY, int size, Image image) {
            super(posX, posY, size, image);
            hitpoints = 20 + (10*MAX_HITPOINTS)/2;
        }
    ...
    private void createTriangleFormation() {
        ...
        int currentY = -180; // Starting Y position of the triangle formation
    ...
    private void createBossFormation() {
        ...
        //spawn head
        int posX = startX;
        bossH.add(new BossH(posX, currentY, ENEMY_SIZE, BOSS_H_IMG));
        
        for (int row = 0; row < 12; row++) {
            int enemiesInRow = 1; // Number of enemies in the current row
            for (int i = 0; i < enemiesInRow; i++) {
                boss.add(new Boss(startX, currentY, ENEMY_SIZE, BOSS_IMG));
            }
